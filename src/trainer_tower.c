...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[105] = {
    {CLASS_TEAM_AQUA,        TRAINER_ENCOUNTER_MUSIC_AQUA},
    {CLASS_AQUA_ADMIN,       TRAINER_ENCOUNTER_MUSIC_AQUA},
    {CLASS_AQUA_LEADER,      TRAINER_ENCOUNTER_MUSIC_AQUA},
    {CLASS_AROMA_LADY_2,     TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_AROMA_LADY,       TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_BATTLE_GIRL,      TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_SWIMMER_FEMALE_2, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_SWIMMER_FEMALE,   TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_BOARDER,          TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_BIKER,            TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_POKEFAN,          TRAINER_ENCOUNTER_MUSIC_TWINS},
    {CLASS_ROCKER,           TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_ENGINEER,         TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_DRAGON_TAMER,     TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_BURGLAR,          TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_PAINTER,          TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_COOL_COUPLE,      TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_COOLTRAINER_2,    TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_COOLTRAINER,      TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_GUITARIST,        TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_GAMER,            TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_SAILOR_2,         TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_SAILOR,           TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_TWINS_2,          TRAINER_ENCOUNTER_MUSIC_TWINS},
    {CLASS_TWINS,            TRAINER_ENCOUNTER_MUSIC_TWINS},
    {CLASS_INTERVIEWER,      TRAINER_ENCOUNTER_MUSIC_INTERVIEWER},
    {CLASS_RUIN_MANIAC_2,    TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_RUIN_MANIAC,      TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_GENTLEMAN_2,      TRAINER_ENCOUNTER_MUSIC_RICH},
    {CLASS_GENTLEMAN,        TRAINER_ENCOUNTER_MUSIC_RICH},
    {CLASS_SWIMMER_MALE_2,   TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {CLASS_SWIMMER_MALE,     TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_POKEMANIAC_2,     TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_POKEMANIAC,       TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_CRUSH_KIN,        TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_CRUSH_GIRL,       TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_BLACK_BELT_2,     TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_BLACK_BELT,       TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_SCIENTIST,        TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_OLD_COUPLE,       TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_CHANNELER,        TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_BUG_MANIAC,       TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_CAMPER_2,         TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_CAMPER,           TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_KINDLER,          TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_TEAM_MAGMA,       TRAINER_ENCOUNTER_MUSIC_MAGMA},
    {CLASS_MAGMA_ADMIN,      TRAINER_ENCOUNTER_MUSIC_MAGMA},
    {CLASS_MAGMA_LEADER,     TRAINER_ENCOUNTER_MUSIC_MAGMA},
    {CLASS_LASS_2,           TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_LASS,             TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_TAMER,            TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_BUG_CATCHER_2,    TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_BUG_CATCHER,      TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_NINJA_BOY,        TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_RICH_BOY,         TRAINER_ENCOUNTER_MUSIC_RICH},
    {CLASS_HEX_MANIAC,       TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_BEAUTY_2,         TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_BEAUTY,           TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_LADY_2,           TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_LADY,             TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_PARASOL_LADY,     TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_PICNICKER_2,      TRAINER_ENCOUNTER_MUSIC_GIRL},
    {CLASS_PICNICKER,        TRAINER_ENCOUNTER_MUSIC_GIRL},
    {CLASS_PKMN_BREEDER_2,   TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_PKMN_BREEDER,     TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_PKMN_PROF,        TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_COLLECTOR,        TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_PKMN_RANGER_2,    TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_PKMN_RANGER,      TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_PKMN_TRAINER_3,   TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_YOUNG_COUPLE_2,   TRAINER_ENCOUNTER_MUSIC_GIRL},
    {CLASS_YOUNG_COUPLE,     TRAINER_ENCOUNTER_MUSIC_GIRL},
    {CLASS_RIVAL,            TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_RIVAL_2,          TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_SUPER_NERD,       TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_TEAM_ROCKET,      TRAINER_ENCOUNTER_MUSIC_AQUA},
    {CLASS_BOSS,             TRAINER_ENCOUNTER_MUSIC_AQUA},
    {CLASS_PSYCHIC_2,        TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_PSYCHIC,          TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_SR_AND_JR,        TRAINER_ENCOUNTER_MUSIC_TWINS},
    {CLASS_ELITE_FOUR_2,     TRAINER_ENCOUNTER_MUSIC_ELITE_FOUR},
    {CLASS_ELITE_FOUR,       TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_CUE_BALL,         TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {CLASS_PLAYER,           TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_YOUNGSTER_2,      TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_YOUNGSTER,        TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_EXPERT,           TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {CLASS_TRIATHLETE,       TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_BIRD_KEEPER_2,    TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_BIRD_KEEPER,      TRAINER_ENCOUNTER_MUSIC_COOL},
    {CLASS_FISHERMAN_2,      TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_FISHERMAN,        TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_CHAMPION_2,       TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_CHAMPION,         TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_TUBER_2,          TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_TUBER_3,          TRAINER_ENCOUNTER_MUSIC_GIRL},
    {CLASS_TUBER,            TRAINER_ENCOUNTER_MUSIC_GIRL},
    {CLASS_SIS_AND_BRO_2,    TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {CLASS_SIS_AND_BRO,      TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {CLASS_HIKER_2,          TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_HIKER,            TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_LEADER_2,         TRAINER_ENCOUNTER_MUSIC_MALE},
    {CLASS_LEADER,           TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {CLASS_JUGGLER,          TRAINER_ENCOUNTER_MUSIC_HIKER},
    {CLASS_SCHOOL_KID,       TRAINER_ENCOUNTER_MUSIC_MALE}
};
...
static void ShowResultsBoard(void)
{
    ...
    AddTextPrinterParameterized(windowId, 2, gText_TimeBoard, 0x4A, 0, TEXT_SPEED_FF, NULL);
    ...
    for (i = 0; i < NUM_TOWER_CHALLENGE_TYPES; i++)
    {
        ...
        AddTextPrinterParameterized(windowId, 2, gTrainerTowerChallengeTypeTexts[i - 1], 0x18, 0x24 + 0x14 * i, TEXT_SPEED_FF, NULL);
        AddTextPrinterParameterized(windowId, 2, gStringVar4, 0x60, 0x2E + 0x14 * i, TEXT_SPEED_FF, NULL);
    }
...
static void PlayTrainerTowerEncounterMusic(void)
{
    ...
    {
        if (sTrainerEncounterMusicLUT[i].trainerClass == gFacilityClassToTrainerClass[facilityClass])
            break;
    }
